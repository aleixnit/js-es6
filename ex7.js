...
/** Prueba de implementar dos versiones: 1. creando un objeto de 0 con las propiedades que se piden. 2. usa el opreador de rest (...) par copiar las propiedades del objeto 'persona' y añade la propiedad 'edad'  */
function calcularEdad(persona) {

    const currentYear = new Date().getFullYear();
    let newPerson = {...persona, 'edad': currentYear - persona.nacimiento};
